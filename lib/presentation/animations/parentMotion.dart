...
class ParentMotionState extends State<ParentMotion> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => ParentCubit(),
        ...
        return SafeArea(
          child: Scaffold(
            ...
            bottomNavigationBar: MotionTabBar(
              ...
              icons: const [Icons.home, Icons.event, Icons.person, Icons.chat],
            ...
            body: TabBarView(
              ...
              children: [
                for(int i=0;i<4;i++)
               ParentCubit.get(context).screens![ParentCubit.get(context).currentIndex!]
              ]
            ),
          ),
        );
