      ...
      child: Container(
        ...
        child: Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              children: [
                MarkItem(text: 'Add Quizzes',
                  image: 'images/plus-solid.png', radius: 35,numS: 25,),
                SizedBox(
                  height: 40,
                ),
                MarkItem(text: 'Quizzes History',
                  image: 'images/view.png', radius: 35,numS: 25,),
                ...
                Padding(
                  ...
                  child: Image.asset('images/exam.png',height: 225,width: 225,
                    fit: BoxFit.cover,),
                ),
