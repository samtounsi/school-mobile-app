...
class ParentTimeTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<StudentTimetableCubit,StudentTimetableStates>(
      ...
      {
        if(state is GetParentStudentTimetableSuccessState)
        {

            model=state.studentTimetable.daysLessons;
        }
        if(state is GetParentStudentTimetableEmptyState){
          model=state.empty.daysLessons;
        }
      },
      builder: (context,state)
      {
        model=StudentTimetableCubit.get(context).parentStudentTimetable==null?StudentTimetableCubit.get(context).emptyTable!.daysLessons
            :StudentTimetableCubit.get(context).parentStudentTimetable!.daysLessons ;
        return Scaffold(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: ConditionalBuilder(
                  condition:state != GetParentStudentTimetableLoadingState && model!=null,
                 builder: (context)
                 {
                   model=StudentTimetableCubit.get(context).parentStudentTimetable==null?StudentTimetableCubit.get(context).emptyTable!.daysLessons
                   :StudentTimetableCubit.get(context).parentStudentTimetable!.daysLessons ;
                   return Column(
                     ...
                     children: [
                       ...
                       DataTable(
                         ...
                         columnSpacing: state is GetParentStudentTimetableSuccessState?25:35,
