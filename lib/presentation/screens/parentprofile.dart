    ...
    return BlocConsumer<ParentCubit, ParentState>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: state is! GetParentProfileLoadingState &&
                  ParentCubit.get(context).parentProfileModel != null ||
  ...
  Widget buildChildItem(Childrens childAccount, index, context) {
    return InkWell(
      onTap: () {
        ...
        ParentCubit.get(context).chooseChild(childAccount.userId);
      },
      child: Container(
        width: 340,
        height: 85,
        ...
        decoration: BoxDecoration(
          ...
          color: childAccount.id == ParentCubit.get(context).childId
        ...
        child: Padding(
          ...
          child: Text(
            childAccount.firstName.toString() +
                ' ' +
