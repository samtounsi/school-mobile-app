                    ...
                    child: SafeArea(
                        child: Padding(
                          ...
                          child: ConditionalBuilder(
                            condition: state is ! SchoolTeacherProfileLoadingState&&TeacherCubit.get(context).teacherProfileModel!=null||
                                state is SchoolTeacherAddProfilePictureLoadingState||state is SchoolTeacherAddBioLoadingState,
                            builder: (context)
                            {
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: ConditionalBuilder(
                                                      condition: state is ! SchoolTeacherAddBioLoadingState,
                                                      builder:(context)
                                                      {
                                                        return IconButton(
                                                            onPressed: (){
                                                              if(formKey.currentState!.validate()){
                                                                TeacherCubit.get(context).postBio(id: id!, bio: bioController.text);
                                                                TeacherCubit.get(context).getTeacherProfile(id: profileId!);
                                                              }
                                                            },
                                                            icon: Icon(
        ...
        child: Padding(
          ...
          child:  CachedNetworkImage(
            ...
            imageBuilder: (context, imageProvider) => ConditionalBuilder(
              condition: state is! SchoolTeacherAddProfilePictureLoadingState,
       ...
       GestureDetector(
            onTap: () {
              if(isBottomSheetShown){
                if(imageFile!=null) {
                  print(imageFile);
                  TeacherCubit.get(context).postProfilePicture(
