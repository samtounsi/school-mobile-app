  ...
  Widget build(BuildContext context) {
    return BlocConsumer<StudentTimetableCubit, StudentTimetableStates>(
      ...
      builder: (context, state) {
        model = StudentTimetableCubit.get(context).studentTimetable == null
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: ConditionalBuilder(
                  condition: state is! GetStudentTimetableLoadingState &&
                      model != null,
                  builder: (context) {
                    model =
                        StudentTimetableCubit.get(context).studentTimetable ==
                                null
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        DataTable(
                          ...
                          columnSpacing:
                              state is GetStudentTimetableSuccessState
                                  ? 25
                                  : 35,
