                  ...
                  child: SafeArea(
                      child: Padding(
                        ...
                        child: ConditionalBuilder(
                          condition:state is ! GetStudentProfileLoadingState&& StudentCubit.get(context).studentProfileModel!=null
                              ||state is AddStudentPictureLoadingState|| state is AddStudentBioLoadingState,
                          builder: (context)
                          {
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  ConditionalBuilder(
                                                    condition: state is ! AddStudentBioLoadingState,
                                                    builder:(context)
                                                    {
                                                      return IconButton(
                                                          onPressed: (){
      ...
      GestureDetector(
        onTap: () {
          if(isBottomSheetShown){
            if(imageFile!=null) {
              print(imageFile);
              StudentCubit.get(context).postProfilePicture(
