...
class SectionTimeTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<StudentTimetableCubit,StudentTimetableStates>(
      ...
      {
        model=StudentTimetableCubit.get(context).sectionTimetable==null?StudentTimetableCubit.get(context).emptyTable!.daysLessons
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: ConditionalBuilder(
                  condition:state != GetSectionTimetableLoadingState && model!=null,
                 builder: (context)
                 {
                   model=StudentTimetableCubit.get(context).sectionTimetable==null?StudentTimetableCubit.get(context).emptyTable!.daysLessons
                   :StudentTimetableCubit.get(context).sectionTimetable!.daysLessons ;
                   return Column(
                     ...
                     children: [
                       ...
                       DataTable(
                         ...
                         columnSpacing: state is GetSectionTimetableSuccessState?25:35,
